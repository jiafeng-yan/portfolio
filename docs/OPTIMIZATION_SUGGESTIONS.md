...
### 中优先级（可选功能）
- [x] **项目缩略图** - 已为公开 arXiv / GitHub 项目生成本地静态截图，并为有证明材料的竞赛项目接入证书预览；无可靠公开素材的项目不强行展示
- [x] **成就证明预览** - 数学竞赛、CSP、蓝桥杯、创新创业和学术科研奖学金支持缩略图及原图查看；公开素材中的身份证号、注册号等敏感字段已遮挡
